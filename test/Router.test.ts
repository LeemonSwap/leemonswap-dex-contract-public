...
describe("Trident", function () {
    ...
    before(async function () {
        ...
        constantProductPoolFactory = await hethers.getContractAt(
            "ConstantProductPoolFactory",
            setupContracts.constantProductPoolFactory
        );
    ...
    it("Should create a Constant Product Pool", async function () {
        ...
        try {
            pool = await constantProductPoolFactory.getPools(
                token0,
                token1,
                0,
                1
        ...
        console.log("[+] Constant Product Pool", pool[0]);
        ...
        console.log("[+] Constant Product Symbol", poolToken);
        console.log("[+] Constant Product Pool Token 0", pToken0);
        console.log("[+] Constant Product Pool Token 1", pToken1);
        console.log("[+] Constant Product LP Token (HTS)", lpToken);
